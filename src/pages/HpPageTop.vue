      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <div class="dropdown-menu dropdown-content">
            ...
            <ul class="media-list dropdown-content-body width-350">
              ...
              <li class="media">
                <div class="media-left">
                  <a href="#" class="btn border-warning text-warning btn-flat btn-rounded btn-icon btn-sm"><i
              ...
              <li class="media">
                <div class="media-left">
                  <a href="#" class="btn border-success text-success btn-flat btn-rounded btn-icon btn-sm"><i
            ...
            <div class="dropdown-content-footer">
              <a href="#" data-popup="tooltip" title="" data-original-title="All activity"><i
        ...
        <li class="dropdown">
          ...
          <div class="dropdown-menu dropdown-content">
            ...
            <div class="dropdown-content-footer">
              <a href="#" data-popup="tooltip" title="" data-original-title="All users"><i
                class="icon-menu display-block"></i></a>
            </div>
          </div>
        </li>
